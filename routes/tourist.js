...
router.post('/searchGuidesAndDeals',touristController.searchGuidesAndDealForAndroid);
...
router.get('/tourist/bookingInfo/:bookingId',auth,touristController.specificBookingDetails)
